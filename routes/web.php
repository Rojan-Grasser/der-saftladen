...
Route::middleware(['auth', 'verified', 'active', 'admin'])
    ...
    ->group(function () {
        ...
        Route::post('/professional-area', [ProfessionalAreaController::class, 'store'])->name('admin.professional-area.create');
        ...
        Route::post('/instructors-to-area/{instructorId}/{areaId}', [InstructorToProfessionalAreaController::class, 'store'])->name('admin.instructors-to-area.add');
